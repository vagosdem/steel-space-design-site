  ...
  return (
    ...
    >
      <div className="flex items-center gap-2 mb-4">
        ...
        <h3 className="text-lg font-semibold text-black">Φίλτρα Προϊόντων</h3>
      </div>
      
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4">
        <div>
          <label className="block text-sm font-medium text-metal-600 mb-2">
            Κατηγορία
          </label>
        ...
        <div>
          ...
          <Select value={typeFilter} onValueChange={setTypeFilter}>
            ...
            <SelectContent>
              ...
              <SelectItem value="single">Μονή πόρτα</SelectItem>
              <SelectItem value="double">Διπλή πόρτα</SelectItem>
              <SelectItem value="multi">Πολλαπλές πόρτες</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        <div>
          ...
          <Select value={featureFilter} onValueChange={setFeatureFilter}>
            ...
            <SelectContent>
              ...
              <SelectItem value="lock">Με κλειδαριά</SelectItem>
              <SelectItem value="ventilation">Με αερισμό</SelectItem>
              <SelectItem value="reinforced">Ενισχυμένο</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        <div>
          ...
          <Select value={sortOption} onValueChange={setSortOption}>
            ...
            <SelectContent>
              ...
              <SelectItem value="popularity">Δημοτικότητα</SelectItem>
