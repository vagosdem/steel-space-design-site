        ...
        <div className="space-y-2">
          ...
          <Select value={typeFilter} onValueChange={setTypeFilter}>
            ...
            <SelectContent>
              ...
              <SelectItem value="standard">Στάνταρντ</SelectItem>
              <SelectItem value="heavy-duty">Βαρέως τύπου</SelectItem>
              <SelectItem value="compact">Συμπαγής</SelectItem>
            </SelectContent>
          </Select>
        </div>
        ...
        <div className="space-y-2">
          ...
          <Select value={featureFilter} onValueChange={setFeatureFilter}>
            ...
            <SelectContent>
              ...
              <SelectItem value="Ανθεκτικό στη σκουριά">Ανθεκτικό στη σκουριά</SelectItem>
              <SelectItem value="Ρυθμιζόμενα ράφια">Ρυθμιζόμενα ράφια</SelectItem>
