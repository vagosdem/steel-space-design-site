...
export const blogPosts: BlogPost[] = [{
  ...
  aspectRatio: "400/600",
  additionalImages: [
    { src: "/lovable-uploads/5501f81b-4623-4d7e-bc60-6e1b2cc5bd76.png" },
    { src: "/lovable-uploads/11c4568f-af5f-4cf4-b8ba-3fcdf68281c7.png" },
    { src: "/lovable-uploads/1b51895c-fa44-45d3-ab17-4267e51f6674.png" },
    { src: "/lovable-uploads/9aec70f5-fdd7-475c-87f1-cea7aff84db4.png" },
  ],
  content: {
  ...
  aspectRatio: "480/650",
  additionalImages: [
    { src: "/lovable-uploads/b45217bd-5df5-40d6-bd0d-ffdee487ec34.png" },
    { src: "/lovable-uploads/68227460-1078-4eca-984f-22b4f3aa6c8f.png" },
    { src: "/lovable-uploads/cd7d3102-6fbc-4f47-bf43-317425889dbb.png" },
    { src: "/lovable-uploads/77f8e1a8-fbb0-48a7-9381-408d7c1354c1.png" },
    {
      src: "/lovable-uploads/3abcd5b1-1501-4546-81da-e9114419c577.png",
      alt: "Μεγάλη συρταριέρα αρχειοθέτησης",
    }
  ],
  content: {
  ...
  aspectRatio: "480/650",
  additionalImages: [
    { src: "/lovable-uploads/084a688a-d669-4431-9004-bf34d61b6bf7.png" },
    { src: "/lovable-uploads/9f0e798d-5876-4415-8dfd-ffa267cf127d.png" },
    { src: "/lovable-uploads/IMG_23802.webp" },
    {
      src: "/lovable-uploads/3abcd5b1-1501-4546-81da-e9114419c577.png",
      alt: "Μεγάλη συρταριέρα αρχειοθέτησης",
    },
    ...
    sections: [
      {
        ...
        content: [
          ...
          "Μέγιστη Ασφάλεια Εγγράφων: Η φύλαξη ευαίσθητων ή εμπιστευτικών αρχείων απαιτεί υψηλό επίπεδο ασφάλειας. Οι μεταλλικές αρχειοθήκες παρέχουν προηγμένα συστήματα κλειδώματος (κεντρικό κλείδωμα, κλειδαριές ασφαλείας) που προστατεύουν τα έγγραφα από μη εξουσιοδοτημένη πρόσβαση, κλοπή ή ζημιά.",
