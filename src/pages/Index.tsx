  ...
  return (
    <>
      <SEOHead 
        ...
        description="Κατασκευάζουμε custom μεταλλικές λύσεις αποθήκευσης από το 1967. Υλικά ποιότητας, 10ετής εγγύηση, παράδοση στην ώρα. Ιδανικές για μεγάλες παραγγελίες σε βιομηχανίες, σχολεία, γραφεία."
        canonical="/"
