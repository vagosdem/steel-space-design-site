...
export default function Products() {
  ...
  const getPageTitle = () => {
    switch(categoryFilter) {
      ...
      default:
        return "Όλα τα Μεταλλικά Προϊόντα: Ντουλάπες, Lockers, Συρταριέρες | Stereom.gr";
    }
  };
  ...
  const getPageDescription = () => {
    switch(categoryFilter) {
      ...
      default:
        return "Ανακαλύψτε την πλήρη γκάμα μεταλλικών ντουλαπιών μας: επαγγελματικά ντουλάπια γραφείου, σχολικά lockers, βιομηχανικά συστήματα αποθήκευσης, ντουλάπια με γυάλινες πόρτες. Custom κατασκευές για μεγάλες παραγγελίες.";
    }
  };
