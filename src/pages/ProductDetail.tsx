...
const products = [
  {
    ...
    features: [
      "Διπλές πόρτες για εύκολη πρόσβαση",
      "Κόκκινο και μαύρο χρώμα για βιομηχανική εμφάνιση",
      "Ανθεκτική μεταλλική κατασκευή βαρέως τύπου",
      "Ιδανική για εργαστήρια και βιομηχανικούς χώρους",
      "Ασφαλές σύστημα κλειδώματος",
      "Αντιχαρακτική και αντισκωριακή επιφάνεια"
    ],
    dimensions: {
      width: "100 εκ.",
      height: "200 εκ.",
  ...
  },
  {
    ...
    features: [
      ...
      "Ανθεκτική μεταλλική κατασκευή",
      "Προσαρμοσμένες λύσεις οργάνωσης",
  ...
  },
  {
    ...
    features: [
      "Μοντέρνος σχεδιασμός με καθαρές γραμμές",
      "Ανθεκτική μεταλλική κατασκευή",
      "Κλειδαριά ασφαλείας",
      "Σύστημα εξαερισμού",
      "Εύκολη εγκατάσταση"
